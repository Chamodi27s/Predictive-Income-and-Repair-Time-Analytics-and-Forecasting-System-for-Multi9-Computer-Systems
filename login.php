...
// 1. පරිශීලකයා දැනටමත් login වී ඇත්නම්, ඔහුව dashboard (index.php) වෙත යවන්න
// මෙය login.php එක ඇතුළේ තැබිය යුතු නිවැරදි ක්‍රමයයි
if (isset($_SESSION['username'])) {
    header("Location: index.php");
    exit();
}

// 2. Variable එක මුලින්ම define කරන්න (Undefined error එක නැති කිරීමට)
$error = '';
...
<head>
    ...
    <style>
        /* ඔබේ CSS code එක මෙතැන එලෙසම තියෙන්න දෙන්න */
