...
if (isset($_POST['reset'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'vibuddha2025@gmail.com'; 
            $mail->Password   = 'jzfdneipexlnjzat';       
...
<head>
    ...
    <title>Forgot Password | Multi 9</title>
    ...
    <style>
        * {
        ...
        @media (max-width: 480px) {
            ...
            input[type="email"] { padding: 13px 15px 13px 44px; font-size: 14px; }
...
<div class="container">
    ...
    <p class="desc">Enter your registered email address to receive a 6-digit security code (OTP).</p>
    ...
    <a href="login.php" class="back-link"><i class="ph-bold ph-arrow-left"></i> Back to Login</a>
</div>
