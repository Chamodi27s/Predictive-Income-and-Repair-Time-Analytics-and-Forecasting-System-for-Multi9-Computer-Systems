...
$job_no = (int) $_GET['id']; // basic security

/* ===============================
   Fetch Job + Customer + Device
================================ */
$sql = "SELECT j.*, 
               c.customer_name, 
               c.address, 
...
<div class="container">
    ...
    <div style="display:flex; gap:50px;">
        <div>
            <h4>Customer Info</h4>
            <p><b>Name:</b> <?php echo htmlspecialchars($data['customer_name']); ?></p>
            <p><b>Phone:</b> <?php echo htmlspecialchars($data['phone_number']); ?></p>
            <p><b>Address:</b> <?php echo htmlspecialchars($data['address']); ?></p>
        </div>

        <div>
            <h4>Device Info</h4>
            <p><b>Device:</b> <?php echo htmlspecialchars($data['device_name']); ?></p>
            <p><b>Model:</b> <?php echo htmlspecialchars($data['model']); ?></p>
            <p><b>Status:</b> <?php echo htmlspecialchars($data['job_status']); ?></p>
        </div>
    </div>
    ...
    <form action="generate_invoice.php" method="POST">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="qty" min="1" value="1" style="width:80px; padding:8px;">
                </td>
                <td>
                    <input type="text" placeholder="Auto" readonly style="width:120px; padding:8px; background:#eee;">
                </td>
            </tr>
        </table>
